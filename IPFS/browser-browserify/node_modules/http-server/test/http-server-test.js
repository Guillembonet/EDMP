...
vows.describe('http-server').addBatch({
  'When http-server is listening on 8080': {
    ...
    'it should serve files from root directory': {
      topic: function () {
        request('http://127.0.0.1:8888/file', this.callback);
      },
    ...
    'when requesting non-existent file': {
      topic: function () {
        request('http://127.0.0.1:8888/404', this.callback);
      },
    ...
    'when requesting /': {
      topic: function () {
        request('http://127.0.0.1:8888/', this.callback);
      },
    ...
    'When http-server is proxying from 8081 to 8080': {
      ...
      'it should serve files from the proxy server root directory': {
        topic: function () {
          request('http://127.0.0.1:8888/root/file', this.callback);
        },
